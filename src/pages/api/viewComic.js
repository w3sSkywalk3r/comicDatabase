...
export default function handler(req, res) {
    ...
    connection.query(
        ...
        GROUP_CONCAT(DISTINCT Letterer.name ORDER BY Letterer.name ASC SEPARATOR ', ') AS letterers
        FROM Comic 
        ...
        LEFT JOIN ComicLetterer ON Comic.id = ComicLetterer.comicId
        LEFT JOIN Letterer ON ComicLetterer.lettererId = Letterer.id
        GROUP BY Comic.id`,
        (error, results, fields) => {
            ...
            // send the comics as JSON data to the frontend
